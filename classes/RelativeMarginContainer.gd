...
class_name RelativeMarginContainer # A container that adjusts its children relative to its own size.
extends Container

# source: https://github.com/DeerTears/Godot-RelativeMargin
